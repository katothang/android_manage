    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnThemSP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbManager.insertSanPham(new SanPham(editName.getText().toString(), bm,loai.getSelectedItem().toString()));
                Toast.makeText(ThemSanPhamActivity.this, "Thêm thành công sản phẩm", Toast.LENGTH_SHORT).show();
            }
        });
